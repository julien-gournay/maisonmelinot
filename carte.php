...
$pdfRelativePath = 'files/carte-food.pdf';
...
<head>
    ...
    <title>Notre carte - <?php echo htmlspecialchars($restaurantName, ENT_QUOTES, 'UTF-8'); ?></title>
...
<body>
    <?php
    $activePage = 'nourriture';
    $mobileMenuId = 'mobile-menu-carte';
    $headerAbsolute = true;
    ...
    <section class="relative h-[46vh] min-h-[320px] overflow-hidden">
        ...
        <div class="relative z-10 flex h-full items-center justify-center px-6 text-center">
            <div>
                ...
                <h1 class="text-4xl font-normal uppercase tracking-[0.22em] text-white md:text-6xl">Carte des plats</h1>
            </div>
        </div>
    </section>
    ...
    <main class="mx-auto max-w-6xl px-6 py-16 lg:px-10">
        <section class="rounded-lg border border-zinc-200 bg-[#EDE8D0] p-6 shadow-sm md:p-8">
            <div class="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <h2 class="section-title text-xl md:text-2xl">Consulter la carte PDF</h2>
