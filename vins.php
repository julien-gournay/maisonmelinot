...
$pdfRelativePath = 'files/carte-vins.pdf';
...
<head>
    ...
    <title>Nos vins - <?php echo htmlspecialchars($restaurantName, ENT_QUOTES, 'UTF-8'); ?></title>
    ...
    <section class="relative h-[46vh] min-h-[320px] overflow-hidden">
        ...
        <div class="relative z-10 flex h-full items-center justify-center px-6 text-center">
            <div>
                ...
                <h1 class="text-4xl font-normal uppercase tracking-[0.22em] text-white md:text-6xl">Carte des vins</h1>
            </div>
        </div>
    </section>
